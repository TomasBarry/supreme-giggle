    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            while (fileNames == null) {
                Log.i("Giggle_FBA_onCreate", "Waiting");
                Thread.sleep(250);
            }
        }
        catch (Exception e) {
            Log.e("Giggle_FBA_onCreate", "Exception: " + e.toString(), e);
        }
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(FileBrowserActivity.this);
        ...
        list.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> myAdapter, View myView, int myItemInt, long mylng) {
                        Log.i("Giggle_FBA_onCreate", "File clicked: " + fileNames[myItemInt]);
                        builder.show();
                    }
                }
        );
